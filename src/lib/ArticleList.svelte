...
<div class="grid grid-cols-2">
	<div class="text-left">
		<a
			class="uppercase text-amber-500 hover:text-sky-500 font-bold text-3xl {previousLink ||
	...
	<div class="text-right">
		<a
			class="uppercase text-amber-500 hover:text-sky-500 font-bold text-3xl {nextLink ||
				'pointer-events-none text-gray-400'}"
